...
public class Demo_timeEntry extends TestBase {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		//login page>select project and task > click add button
		...
		Demo_timeEntry demo_timeEntry=new Demo_timeEntry();
		demo_timeEntry.first_Hourse("12");
		Thread.sleep(1000);
		demo_timeEntry.first_minute("35");
		Thread.sleep(2000);
		demo_timeEntry.clickOn_from_Am_pm("PM");
		demo_timeEntry.second_Hourse("9");
		Thread.sleep(2000);
		demo_timeEntry.second_minute("30");
		Thread.sleep(1000);
		demo_timeEntry.clickOn_to_Am_pm("PM");
		Thread.sleep(1000);
